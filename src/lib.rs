...
#[derive(Debug)]
pub struct TerraformAwsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TerraformAwsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TerraformAws processing");
    
    let mut processor = TerraformAwsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TerraformAwsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TerraformAwsProcessor::new(false);
